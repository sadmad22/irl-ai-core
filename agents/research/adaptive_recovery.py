...
def _claim_plan(gate: str, failure_type: str, claim: Mapping[str, Any], audit: Mapping[str, Any]) -> RecoveryPlan:
    ...
    if failure_type in {"insufficient_evidence", "missing_evidence_refs", "disputed_claim"}:
        ...
        return _plan(
            ...
            rationale=rationale,
            actions=[
                "Acquire authoritative evidence for the claim.",
                "Attach verified evidence references to the claim.",
            ],
    ...
    return _plan(
        ...
        actions=[
            "Revise or remove the targeted claim.",
            "Preserve evidence lineage while revising the claim.",
        ],
