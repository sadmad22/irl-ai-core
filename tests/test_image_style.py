        ...
        "images": [
            {
                ...
                "section_heading": "Introduction", "purpose": "Establish the topic visually.",
            ...
            },
            {
                ...
                "section_heading": "Coverage and Key Factors", "purpose": "Support the key concept.",
...
def test_engine_output_has_expected_contract_shape():
    ...
    assert result["visual_style"]["brand"] == "Insurance Review Lab"
...
def test_brand_palette_is_explicit():
    ...
    assert palette == {
        "deep_navy": "#0F172A", "modern_blue": "#2563EB",
        "cyan_accent": "#06B6D4", "white": "#FFFFFF",
    }
...
def test_engine_excludes_generation_and_media_strategy():
    ...
    assert result["constraints"] == {
        "network_access": False, "provider_call": False,
        "image_analysis_call": False, "media_strategy_included": False,
