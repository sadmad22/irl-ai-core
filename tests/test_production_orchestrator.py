...
def test_non_delivery_orchestration_completes_at_qa():
    ...
    assert orchestration["remaining_stages"] == ["media", "linking", "production_assembly", "article_package", "production_delivery_boundary", "wordpress_delivery"]
