...
def test_research_to_content_vertical_slice(monkeypatch, tmp_path):
    ...
    def fake_content_brief(project_name: str) -> dict:
        ...
        brief = {
            ...
            "content_type": "guide",
            "evidence_refs": ["e1"],
            "outline": [{"heading": "Introduction", "purpose": "Answer the core question."}],
    ...
    assert result["article_draft"]["evidence_refs"] == ["e1"]
    assert result["article_draft"]["sections"][0]["evidence_refs"] == ["e1"]
